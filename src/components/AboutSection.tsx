...
export default function AboutSection() {
  return (
    <section id="our-story" className="py-12 sm:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-montserrat font-bold tracking-wide text-stone-900 uppercase">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 pt-4 sm:pt-6">
              <div className="bg-stone-50 border border-stone-200 p-4 sm:p-5 text-center">
                <h4 className="font-semibold text-stone-900 text-sm sm:text-base mb-1 sm:mb-2">Quality That Lasts</h4>
                <p className="text-xs sm:text-sm text-stone-600">
                  Premium fabrics that hold up round after round
                </p>
              </div>
              <div className="bg-stone-50 border border-stone-200 p-4 sm:p-5 text-center">
                <h4 className="font-semibold text-stone-900 text-sm sm:text-base mb-1 sm:mb-2">Fresh Designs</h4>
                <p className="text-xs sm:text-sm text-stone-600">
                  Golf style that doesn't look like your dad's closet
                </p>
              </div>
              <div className="bg-stone-50 border border-stone-200 p-4 sm:p-5 text-center">
                <h4 className="font-semibold text-stone-900 text-sm sm:text-base mb-1 sm:mb-2">By Golfers</h4>
                <p className="text-xs sm:text-sm text-stone-600">
