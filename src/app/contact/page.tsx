      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-center text-stone-600 mb-12 max-w-lg mx-auto">
            Got questions? Want to partner up? Just want to talk golf? We're all ears.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div>
                ...
                <a href="mailto:hello@backnineshop.com" className="text-emerald-700 hover:text-emerald-800 transition-colors">
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white border border-stone-200 focus:outline-none focus:border-stone-400 rounded"
                  />
                  <input
                    type="email"
                    placeholder="Email"
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-white border border-stone-200 focus:outline-none focus:border-stone-400 resize-none rounded"
                  />
                  <button
                    type="submit"
                    disabled={isLoading}
